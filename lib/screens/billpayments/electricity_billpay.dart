...
class ElectriccityBillPay extends StatefulWidget {
  const ElectriccityBillPay({super.key});

  @override
  State<ElectriccityBillPay> createState() => _ElectriccityBillPayState();
}

class _ElectriccityBillPayState extends State<ElectriccityBillPay> {
                ...
                child: Column(
                  children: <Widget>[
                    const CustomTextWidget(
                      text: 'Pay Your ElectricCity Bill',
                      fontsize: 20,
                    ),
                    Image.asset(
                          ...
                          suffixIcon: GestureDetector(
                            ...
                            onTap: () {
                              setState(() {
                                ...
                                billAmountControler.text = '587 AED';
                                billnameController.text = 'Surya';
                              });
                            },
                          )),
                      name: 'Bill number',
