...
class WaterBillPay extends StatefulWidget {
  const WaterBillPay({super.key});

  @override
  State<WaterBillPay> createState() => _WaterBillPayState();
}

class _WaterBillPayState extends State<WaterBillPay> {
  ...
  List<DropdownItem> billers = [
    DropdownItem(text: '87648794', cardType: 'VISA', cardNumber: 'DEWA'),
    DropdownItem(
        text: '65976445', cardType: 'MASTER', cardNumber: 'Oasis Pure Water'),
    DropdownItem(
        text: '98564759', cardType: 'VISA', cardNumber: 'Agthia Group PJSC'),
  ];
  late DropdownItem selectedbiller = billers[1];
                  ...
                  children: <Widget>[
                    ...
                    FormBuilderTextField(
                      decoration: InputDecoration(
                          labelText: 'Enter Your Water Bill number',
                    ...
                    Container(
                      ...
                      child: DropdownButtonFormField<DropdownItem>(
                        ...
                        items: billers.map<DropdownMenuItem<DropdownItem>>(
                            (DropdownItem item) {
